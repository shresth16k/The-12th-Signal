...
from main import app, signals_db, clusters_db, rumors_history
...
def test_get_rumors(mock_cluster_signals, mock_detect_rumor):
    ...
    mock_detect_rumor.return_value = RumorAlert(
        cluster_id="clus_rumor_active",
        suspected_claim="False fire report.",
        suggested_correction="No fire detected."
    )
