...
def get_medical_opinion(cluster: SignalCluster, signals: Optional[List[FanSignal]] = None) -> AgentOpinion:
    """Analyze a signal cluster from the perspective of medical and safety operations.
    ...
    Returns:
        AgentOpinion: An opinion containing medical recommendations, reasoning, and constraints.
    """
