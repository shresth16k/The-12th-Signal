...
export default function SignalSubmit() {
  ...
  if (isSubmitted) {
    return (
      <div className="p-4 w-full max-w-md mx-auto bg-slate-900 border border-slate-800 rounded-lg text-slate-100 animate-fadeIn">
        <div className="flex flex-col items-center justify-center py-6 text-center">
          ...
          <h2 className="text-base font-bold text-white mb-1">Signal Submitted</h2>
  ...
  return (
    <div className="p-4 w-full max-w-md mx-auto bg-slate-900 border border-slate-800 rounded-lg text-slate-100">
      <h2 className="text-base font-bold mb-3 text-white">Report Stadium Issue / Ask Question</h2>
      <form onSubmit={handleSubmit} className="flex flex-col gap-3">
        <div>
          ...
          <textarea
            ...
            className="w-full p-2 text-xs bg-slate-950 border border-slate-800 rounded text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
            rows={4}
            required
        ...
        <button
          ...
          className="w-full py-2 bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs rounded transition-colors disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
        >
