    ...
    <header className="w-full bg-brand-black/90 backdrop-blur-lg border border-slate-800/60 rounded-xl px-2.5 py-2.5 flex items-center justify-between text-slate-100 select-none shadow-[0_8px_32px_rgba(0,0,0,0.4)] transition-all duration-300">
      ...
      <div className="flex items-center gap-1.5 min-w-0">
        <div className="relative group cursor-pointer shrink-0">
          ...
          <div className="relative w-8 h-8 rounded-lg bg-slate-900/90 flex items-center justify-center border border-slate-700/50 group-hover:border-accent-purple/50 transition-all duration-300">
            ...
            <svg className="w-5 h-5 text-accent-purple group-hover:text-white transition-colors duration-300" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M4 14V10C4 8.89543 4.89543 8 6 8H7C8.10457 8 9 8.89543 9 10V14C9 15.1046 8.10457 16 7 16H6C4.89543 16 4 15.1046 4 14Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M12 8V16M12 16H14M12 8H13.5C14.5 8 15 8.5 15 9.5C15 10.5 14.5 11 13.5 11H12" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        ...
        <div className="flex flex-col text-left min-w-0">
          ...
          <span className="text-[7.5px] text-slate-400 font-bold tracking-wider uppercase truncate">
            12th Signal
          </span>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center shrink-0">
        ...
        >
          ...
          <svg className="w-4 h-4 group-hover:animate-wiggle" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
