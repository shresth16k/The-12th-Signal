  ...
  const playbookData: PlaybookSOP[] = [
    {
      ...
      count: 14,
      description: 'Egress/ingress re-routing protocols. Activates directional arrow video displays, updates transit twins, and deploys local guides to redirect spectators from congested gates.',
      status: 'Nominal'
    },
    {
      code: 'SOP-024',
      ...
      count: 9,
      description: 'Triggered by high purchasing signals. Coordinates stock delivery runners to Stand B/C and instructs vendors to run express checkout procedures.',
      status: 'Nominal'
    },
    {
      code: 'SOP-008',
      ...
      count: 3,
      description: 'Alerts facilities maintenance crews, switches main valves to backup lines, and posts map guides redirecting fans to adjacent working restrooms.',
      status: 'Nominal'
    },
    {
      code: 'SOP-042',
      ...
      count: 11,
      description: 'Calculates nearest mobile first-aid patrol unit using signal telemetry. Dispatches unit while reserving priority ambulance ingress/egress corridors.',
      status: 'Nominal'
    },
    {
      code: 'SOP-089',
      ...
      count: 12,
      description: 'Invokes AI Rumor Shield to cross-reference crowd panic terms against official sensors. Pushes fact-checking PA overlays to correct misstatements.',
      status: 'Nominal'
    }
  ];
