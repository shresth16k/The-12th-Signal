  ...
  const baseZones = [
    {
      ...
      name: 'Zone A (101)',
      zoneMatch: 'Zone A',
      path: 'M 100 20 A 80 80 0 0 1 156.56 43.43 L 132.42 67.57 A 46 46 0 0 0 100 54 Z',
      labelX: 125,
      labelY: 42,
    },
    {
      ...
      name: 'Zone B (102)',
      zoneMatch: 'Zone B',
      path: 'M 156.56 43.43 A 80 80 0 0 1 180 100 L 146 100 A 46 46 0 0 0 132.42 67.57 Z',
      labelX: 158,
      labelY: 75,
    },
    {
      ...
      name: 'Zone C (103)',
      zoneMatch: 'Zone C',
      path: 'M 180 100 A 80 80 0 0 1 156.56 156.56 L 132.42 132.42 A 46 46 0 0 0 146 100 Z',
      labelX: 158,
      labelY: 125,
    },
    {
      ...
      name: 'Zone D (104)',
      zoneMatch: 'Zone D',
      path: 'M 156.56 156.56 A 80 80 0 0 1 100 180 L 100 146 A 46 46 0 0 0 132.42 132.42 Z',
      labelX: 125,
      labelY: 158,
    },
    {
      ...
      name: 'Zone E (105)',
      zoneMatch: 'Zone E',
      path: 'M 100 180 A 80 80 0 0 1 43.43 156.56 L 67.57 132.42 A 46 46 0 0 0 100 146 Z',
      labelX: 75,
      labelY: 158,
    },
    {
      ...
      name: 'Zone F (106)',
      zoneMatch: 'Zone F',
      path: 'M 43.43 156.56 A 80 80 0 0 1 20 100 L 54 100 A 46 46 0 0 0 67.57 132.42 Z',
      labelX: 42,
      labelY: 125,
    },
    {
      ...
      name: 'Zone G (107)',
      zoneMatch: 'Zone G',
      path: 'M 20 100 A 80 80 0 0 1 43.43 43.43 L 67.57 67.57 A 46 46 0 0 0 54 100 Z',
      labelX: 42,
      labelY: 75,
    },
    {
      ...
      name: 'Zone H (108)',
      zoneMatch: 'Zone H',
      path: 'M 43.43 43.43 A 80 80 0 0 1 100 20 L 100 54 A 46 46 0 0 0 67.57 67.57 Z',
      labelX: 75,
      labelY: 42,
    },
  ];
          ...
          {zones.map((z) => {
            ...
            return (
              <g key={z.id} className="cursor-pointer group">
                <path d={z.path} className={`${fillColor} transition-all duration-300`} strokeWidth="1.5" />
                <text
                  x={z.labelX}
                  y={z.labelY}
                  textAnchor="middle"
        ...
        {activeZones.length > 0 && (
          <div className="absolute right-0 bottom-0 bg-brand-black/85 border border-slate-850 rounded-lg p-2 flex flex-col gap-1 text-[9px] font-medium backdrop-blur-md max-w-[120px] shadow-lg">
            {activeZones.map((z) => (
              ...
              >
                <span
                  className={`h-1.5 w-1.5 rounded-full shrink-0 ${z.status === 'danger' ? 'bg-danger-red' : 'bg-warning-amber'}`}
                />
