          ...
          return (
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <div className="flex flex-col">
                  <span className="text-[10px] font-bold text-slate-350 leading-tight">
                    {s.name}
                  </span>
              ...
              <div className="flex items-center gap-2">
                <span className={`text-[7.5px] font-bold px-1 py-0.2 rounded border uppercase tracking-wide ${
                  isActive 
                ...
                >
                  <div className={`bg-slate-100 w-2.5 h-2.5 rounded-full shadow-sm transform transition-all duration-200 ${
